...
# 원티드 데이터
wanted = pd.read_csv(Task3_path + 'wanted.csv')
...
# 원티드 wanted.csv 업데이트
wanted.to_csv(Task3_path + 'wanted.csv', index=False, encoding='utf-8-sig')
wanted = pd.read_csv(Task3_path + 'wanted.csv')

# 잡플래닛 데이터
jobplanet = pd.read_csv(Task4_path + 'jobplanet.csv')
